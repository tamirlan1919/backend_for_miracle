"use strict";(self.webpackChunknew_backend=self.webpackChunknew_backend||[]).push([[9553],{89630:(xt,k,n)=>{n.d(k,{c:()=>B});var t=n(74081),_=n(19003),L=n(52185),f=n(67393),x=n(85898),F=n(78565);const S=(0,_.default)(L.x)`
  height: ${24/16}rem;
  width: ${24/16}rem;
  border-radius: 50%;
  display: flex;
